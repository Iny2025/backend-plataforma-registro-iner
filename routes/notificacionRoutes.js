...
router.delete('/usuario/:id', notificacionController.deleteNotificacionUsuario);  // Eliminar notificación por ID
...
router.delete('/iner/:id', notificacionController.deleteNotificacionIner);        // Eliminar notificación por ID
